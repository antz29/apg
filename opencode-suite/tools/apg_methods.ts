...
export default tool({
  ...
  args: {
    ...
    fqn: tool.schema.string().describe("Struct FQN (language-rooted), e.g. java.org.jgrapht.Graph (required)"),
  ...
  async execute(args, context) {
    ...
    // Column 1 is the function's source-file `path` (stored repo-relative).
