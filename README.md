...
```sh
apg --version   # apg 0.6.0
apg --help
```

`v0.6.0` is tagged, so the stable install works as-is. If you want the latest
...
Options: `--version 0.6.0` to pin a specific release, `--prefix DIR` to choose
