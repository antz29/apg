...
export default tool({
  description:
    "Mark a plan task done: `apg plan done <project> <task-fqn>`. The implementer's assertion ONLY — no promotion, no code-graph verification (the plan's Builds futures stay declared until the apply act's coherence gate, PlanCompletion-SPEC.md). Use apg_plan_undone to reverse.",
  args: {
