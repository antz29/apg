...
public static class Program
{
    public static int Main(string[] args)
    {
        ...
        {
            Console.Error.WriteLine("Usage: csharpfrontend <project_dir> [--module <dir>]... [--id-prefix <p>] [exclude_globs...]");
            return 1;
        }
        ...
        try
        {
            var scanner = new Scanner(rootDir, moduleDirs, excludePatterns, idPrefix);
            scanner.Run();
            return 0;
        }
        catch (Exception ex)
